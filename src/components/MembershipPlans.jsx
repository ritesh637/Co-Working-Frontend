        ...
        {plans.map((plan, index) => (
          ...
          >
            ...
            <button
              ...
              className="mt-6 bg-gradient-to-r from-purple-600 to-purple-500 text-white px-6 py-3 rounded-lg font-semibold transition-transform duration-300 hover:scale-105"
            >
              Book a Space
            </button>
          </div>
